                               ...
                               <tbody>
                                   ...
                                   <tr>
                                       ...
                                       <td>
                                        ...
                                        data-id_status="<?= $row['id_status']; ?>" data-status="<?= $row['status']; ?>" > <i class="fa fa-edit"></i> </button>
                                        <button type="button" data-toggle="modal" data-target="#modalHapus" id="btn-hapus" class="btn btn-danger" data-id_status="<?= $row['id_status']; ?>"> 
                       ...
                       <div class="modal-content">
                           <div class="modal-header">
                               <h5 class="modal-title">Ubah <?= $judul; ?></h5>
                                   ...
                                   <a href="/status/ubah<?= $row['id_status']; ?>"> </a>
                           </div>
                           <div class="modal-body">
                               <form action="<?= base_url('status/ubah'); ?>" method="post"> 
                               <input type="hidden" name="id_status" id="status">
                               <div class="form-group ab-0 ab-0">
                                 <label for="id_status"></label>
                                 <input readonly type="text" name="id_status" id="id_status" class="form-control" placeholder="Masukkan Id status" >
                               </div>
                               <div class="form-group ab-0">
                                 <label for="status"></label>
                                 <input type="text" name="status" id="status" class="form-control" placeholder="Masukkan status" >
